...
# Script is at: src/ai_poc/workflow_2/scripts/regenerate_report.py
# .env is at: .env (project root)
# Need to go up 4 levels: scripts -> workflow_2 -> ai_poc -> src -> root
env_path = Path(__file__).resolve().parent.parent.parent.parent.parent / '.env'
load_dotenv(dotenv_path=env_path)

# NOW import the agent (after env vars are loaded)
from src.ai_poc.workflow_2.agents.root_agent import CompetitiveIntelligenceRootAgent
